package com.kashapovrush.godrive.presentation.freeChat
//
...
//        preferenceManager =
//            PreferenceManagerImpl(applicationContext)
...
//
//        database.child(Constants.KEY_COUNT_FREE_APP).child(cityValue.toString())
//            .child(number.toString()).setValue("1")
//    }
//
//
...
//            return Intent(context, FreeChatActivity::class.java)
//        }
//
//    }
//}